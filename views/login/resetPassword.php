...
<body>
    ...
    <section class="background" id="sec-forgotPassword">
        <div id="container-forgotPassword">
            <form class="form" id="form-insertCode" action="" method="POST">

                <p id="forgotPassword-title">Introduzca el código de recuperación</p>

                <div class="division division-register"></div>

                <div class="container-inps-forgotPassword">
                    <input class="inp-login" type="number" placeholder="Código de recuperación" name="code">
